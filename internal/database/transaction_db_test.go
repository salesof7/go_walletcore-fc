...
func (s *TransactionDBTestSuite) SetupSuite() {
	...
	db.Exec("CREATE TABLE transactions (id varchar(255), account_id_from varchar(255), account_id_to varchat(255), amount int, created_at date)")

	client1, _ := entity.NewClient("John", "john@mail.com")
	s.Nil(err)
	s.client1 = client1
	client2, _ := entity.NewClient("John", "john@mail.com")
	s.Nil(err)
	s.client2 = client2
